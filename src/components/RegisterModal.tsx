  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="border-white/10 bg-[#0a0f1e]/90 backdrop-blur-xl sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-2 flex flex-col gap-3" noValidate>
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="reg-org-name" className="text-white/60">Organisation name</Label>
            <Input
              id="reg-org-name"
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="reg-inn" className="text-white/60">
              INN <span className="text-white/30">(optional)</span>
            </Label>
            <Input
              id="reg-inn"
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="reg-full-name" className="text-white/60">Full name</Label>
            <Input
              id="reg-full-name"
              type="text"
              autoComplete="name"
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="reg-email" className="text-white/60">Email</Label>
            <Input
              id="reg-email"
              type="email"
              autoComplete="email"
